...
export class DefaultCamera extends PerspectiveCamera {
    ...
    update(delta) {
        ...
        if(VIRTUAL_ENVIRONMENT.LOCAL_PLAYER.controls) {
            ...
            if( VIRTUAL_ENVIRONMENT.LOCAL_PLAYER.controls.controlVector.z > 0.1 && typeof VIRTUAL_ENVIRONMENT.terrainController.collider !== "undefined" ) {     
            ...
            if (hit) {
                this.cameraDistance = Math.min(hit.distance * 0.8, VIRTUAL_ENVIRONMENT.LOCAL_PLAYER.controls.controlVector.z);
            } else {
                this.cameraDistance = VIRTUAL_ENVIRONMENT.LOCAL_PLAYER.controls.controlVector.z;
            }
